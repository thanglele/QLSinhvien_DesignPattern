...
namespace QLSinhVienCode.Patterns.Builder
{
    ...
    public class MonHocBuilder : IMonHocBuilder
    {
        ...
        public IMonHocBuilder InHocKy(int hocKy) 
        { 
            _monHoc.HocKy = hocKy; 
            return this; 
        }
        public IMonHocBuilder WithMaMon(string maMon) 
        { 
            _monHoc.MaMon = maMon; 
            return this; 
        }
        public IMonHocBuilder WithTenMon(string tenMon) 
        { 
            _monHoc.TenMon = tenMon; 
            return this; 
        }
        public IMonHocBuilder WithSoTinChi(int soTinChi) 
        { 
            _monHoc.SoTinChi = soTinChi; 
            return this; 
        }
        public IMonHocBuilder AssignToKhoa(string maKhoa) 
        { 
            _monHoc.MaKhoa = maKhoa; 
            return this; 
        }
        public IMonHocBuilder AssignToGiangVien(string maGV) 
        { 
            _monHoc.MaGV = maGV; 
            return this; 
        }
