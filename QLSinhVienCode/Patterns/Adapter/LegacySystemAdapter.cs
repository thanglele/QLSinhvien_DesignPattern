...
namespace QLSinhVienCode.Patterns.Adapter
{
    ...
    public class LegacyStudentAdapter
    {
        ...
        public LegacyStudentAdapter(LegacyStudent legacyStudent) { _legacyStudent = legacyStudent; }
        public SinhVien ToNewStudent() => new SinhVien { MaSV = _legacyStudent.StudentID, HoTen = _legacyStudent.FullName };
    }
}
